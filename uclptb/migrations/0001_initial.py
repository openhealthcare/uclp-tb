    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('igm', models.CharField(max_length=20, verbose_name=b'IgM', blank=True)),
                ('igg', models.CharField(max_length=20, verbose_name=b'IgG', blank=True)),
                ('vca_igm', models.CharField(max_length=20, verbose_name=b'IgM', blank=True)),
                ('vca_igg', models.CharField(max_length=20, verbose_name=b'IgG', blank=True)),
                ('ebna_igg', models.CharField(max_length=20, verbose_name=b'EBNA IgG', blank=True)),
                ('hbsag', models.CharField(max_length=20, verbose_name=b'HBsAg', blank=True)),
                ('anti_hbs', models.CharField(max_length=20, verbose_name=b'anti-HbS', blank=True)),
                ('anti_hbcore_igm', models.CharField(max_length=20, verbose_name=b'anti-HbCore IgM', blank=True)),
                ('anti_hbcore_igg', models.CharField(max_length=20, verbose_name=b'anti-HbCore IgG', blank=True)),
                ('rpr', models.CharField(max_length=20, verbose_name=b'RPR', blank=True)),
                ('tppa', models.CharField(max_length=20, verbose_name=b'TPPA', blank=True)),
                ('viral_load', models.CharField(max_length=20, blank=True)),
                ('parasitaemia', models.CharField(max_length=20, blank=True)),
                ('hsv', models.CharField(max_length=20, verbose_name=b'HSV', blank=True)),
                ('vzv', models.CharField(max_length=20, verbose_name=b'VZV', blank=True)),
