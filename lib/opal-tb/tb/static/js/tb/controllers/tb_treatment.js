...
function($modal, $q, ngProgressLite, $controller, scope, step, episode) {
    ...
    */
    ...
    existingTreatment = _.filter(scope.editing.treatment, function(x){
        return !x.end_date || x.end_date > new Date();
    });
    scope.localEditing = {treatmentPlan: angular.copy(existingTreatment)};
        ...
        scope.localEditing.treatmentPlan = [
            {
                ...
                end_date: moment().add(6, 'months').toDate()
            },
            {
                drug: 'Rifampicin',
            ...
            },
            {
                ...
                start_date: moment().toDate(),
                end_date: moment().add(2, 'months').toDate()
            },
            {
                drug: 'ethambutol',
